...
- [Pseudocode Editor API — Frontend Access Guide](#pseudocode-editor-api--frontend-access-guide)
  ...
  - [3. Data Models](#3-data-models)
    - [3.1 `PseudocodeDocument` (Response Model)](#31-pseudocodedocument-response-model)
    - [3.2 `CreatePseudocodeRequest` (POST body)](#32-createpseudocoderequest-post-body)
    - [3.3 `UpdatePseudocodeRequest` (PUT body)](#33-updatepseudocoderequest-put-body)
    - [3.4 `ValidateContentRequest` (POST body for `/validate`)](#34-validatecontentrequest-post-body-for-validate)
    - [3.5 `ValidationResult` (Response from `/validate`)](#35-validationresult-response-from-validate)
    - [3.6 `FormatContentRequest` (POST body for `/format`)](#36-formatcontentrequest-post-body-for-format)
    - [3.7 `FormatContentResponse` (Response from `/format`)](#37-formatcontentresponse-response-from-format)
    - [3.8 Error Response (all endpoints)](#38-error-response-all-endpoints)
  ...
  - [6. TypeScript / JavaScript Client Examples](#6-typescript--javascript-client-examples)
    ...
    - [6.2 API Client](#62-api-client)
    - [6.3 Usage Example](#63-usage-example)
  - [7. Error Handling Patterns](#7-error-handling-patterns)
    - [7.1 Network / Connection Errors](#71-network--connection-errors)
    - [7.2 HTTPS Certificate Errors (Development)](#72-https-certificate-errors-development)
