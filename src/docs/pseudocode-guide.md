...
Cambridge International is committed to providing exceptional quality. In line with this commitment, our quality management system for the provision of international education programmes and qualifications programmes for students aged 5 to 19 is independently certified as meeting the internationally recognised standard, ISO 9001:2015. Learn more at www.cambridgeinternational.org/about-us/our-standards/
...
1. [Pseudocode in examined components](#1-pseudocode-in-examined-components)
...
4. [User-defined data types](#4-user-defined-data-types)
...
7. [Iteration (repetition)](#7-iteration-repetition)
...
[Index of symbols and keywords](#index-of-symbols-and-keywords)
...
- Date
 ...
 Always written with at least one digit on either side of the decimal point, zeros being added if
necessary, e.g. 4.7, 0.3, -4.0, 0.0
A single character delimited by single quotes e.g. 'x', 'C', '@'
Delimited by double quotes. A string may contain no characters (i.e. the empty string)
e.g. "This is a string", ""
TRUE, FALSE
 This will normally be written in the format dd/mm/yyyy. However, it is good practice to state
...
- WRITE
 ...
 for data to be written to the file. A new file will be created and any existing data in the file will
be lost.
